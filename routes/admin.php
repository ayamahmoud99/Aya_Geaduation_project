...
Route::group(
    ...
    Route::group(['namespace' => 'Dashboard', 'middleware' => 'auth:admin', 'prefix' => 'admin'], function () {
        ...
        Route::get('/', 'DashboardController@index')->name('admin.dashboard');//the first page admins visits if authentication
        ...
        Route::group(['prefix' => 'main_categories'], function () {
            ...
            Route::post('update/{id}', 'MainCategoriesController@update')->name('category.update');
...
//            ,'middleware' => 'can:tags'
        ...
        Route::group(['prefix' => 'orders'], function () {
            ...
            Route::get('/details/{id}', 'OrderController@details')->name('admin.orders.details');
        });
        ################################## end Orders    #######################################
