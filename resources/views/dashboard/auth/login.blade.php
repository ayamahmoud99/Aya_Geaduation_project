                    ...
                    <div class="card-header border-0">
                        <div class="card-title text-center">
                            <div class="p-1">
                                ...
                                <img  src="{{asset('assets/front/img/logo.jpg')}}" width=150px alt="LOGO"/>
{{--                                <br/>--}}
{{--                           <h3>welcome to Aya_Store</h3>--}}
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal form-simple" action="{{route('admin.post.login')}}" method="Post"
                                ...
                                <button type="submit" id="aya" class=" btn btn-info btn-lg btn-block"><i class="ft-unlock"></i>
                                    <style> #aya {    border-color: #ffa000 !important;
                                            background-color: #d64a24 !important;
